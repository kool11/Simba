...
<<<<<<< HEAD
      .config("simba.index.partitions", "150")
      .getOrCreate()
    if(args.length>=1){
...
//    }
>>>>>>> 0e1b96f78e230df3476f2fd845cbc47bb46d2572
//
//    useIndex1(simbaSession,args)
...
>>>>>>> 0e1b96f78e230df3476f2fd845cbc47bb46d2572
    ...
    val out2 = new FileWriter(args(2),true)
    for(i<-costTime) {
